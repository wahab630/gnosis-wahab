        ...
        <div className="SectionTwo-firstSection">
          <div className="row">
            <div className="col-6 left-section">
              <h1 className="heading-one font-weight-bold">
                Build on <br /> Gnosis
              </h1>
            </div>
            ...
            <div className="col-6 right-section">
              <p className="para-one">
                ...
                <span>Gnosis Ecosystem Fund (GECO)</span> provides teams with
                mentoring, marketing, and funding up to $100,000 to build on
                Gnosis.
              </p>
              <button className="Button-one"> <span > Get Started </span> <span className="ps-5"><FaArrowRight/> </span></button>
            </div>
          </div>
        </div>
        <div className="SectionTwo-secondSection">
          <div className="row">
            <div className="col-6 left-sec">
              ...
              />
              <button className="Button-two">Visit Forum  <span className="ps-1"><FaArrowRight/> </span></button>
            </div>
